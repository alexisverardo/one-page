      ...
      <div class="container">
		...
		<div class="container" id="services" name="services">
			...
			<div class="row">
				...
				<br>
				<div class="col-lg-offset-2 col-lg-8">
					<img class="img-responsive" src="{{asset('img/iphone.png')}}" alt="">
				</div><!-- col -->
			</div><!-- row -->
		</div><!-- container -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8 centered">
						<img class="img-responsive" src="{{asset('img/macbook.png')}}" align="">
					</div>
					<div class="col-lg-4">
						<h2>We Are Hiring!</h2>
		...
		<br>
			...
			<div class="row">	
				...
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="{{asset('img/portfolio/folio01.jpg')}}" alt="">
							<figcaption>
								<h5>DASHBOARD</h5>
						    ...
						    <div class="modal-dialog">
						      <div class="modal-content">
						        ...
						        <div class="modal-body">
						          <p><img class="img-responsive" src="{{asset('img/portfolio/folio01.jpg')}}" alt=""></p>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="{{asset('img/portfolio/folio02.jpg')}}" alt="">
							<figcaption>
								<h5>UI DESIGN</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="{{asset('img/portfolio/folio03.jpg')}}" alt="">
							<figcaption>
								<h5>ANDROID PAGE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
			...
			<div class="row">	
				<div class="col-md-4 ">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="{{asset('img/portfolio/folio04.jpg')}}" alt="">
							<figcaption>
								<h5>PROFILE</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="{{asset('img/portfolio/folio05.jpg')}}" alt="">
							<figcaption>
				...
				<div class="col-md-4">
			    	<div class="grid mask">
						<figure>
							<img class="img-responsive" src="{{asset('img/portfolio/folio06.jpg')}}" alt="">
							<figcaption>
								<h5>PHONE MOCKUP</h5>
								<a data-toggle="modal" href="#myModal" class="btn btn-primary btn-lg">Take a Look</a>
							</figcaption><!-- /figcaption -->
